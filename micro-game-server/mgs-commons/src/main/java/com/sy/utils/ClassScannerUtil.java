...
//		InputStream resourceAsStream = ClassUtils.class.getClassLoader().getResourceAsStream(packagePath);
		//InputStream resourceAsStream = loader.getResourceAsStream(packagePath);
		
//		DatabaseReader reader  = new DatabaseReader
//                .Builder(dbAsStream)
//                .fileMode(Reader.FileMode.MEMORY)
//                .build();
		//IOUtils.readLines(resourceAsStream).forEach(System.out::println);
		if (url != null) {
